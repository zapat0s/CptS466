...
#include "../includes/WFConsole.h"

#if defined( WF_CONSOLE_IFCFGUTIL )

#include "../includes/WFConsoleMsgs.h"
#include "../includes/WFConsoleMsgHandler.h"
#include "../includes/WFConsoleIwconfig.h" // for using iwconfigCb
#include "../includes/WFConsoleIwpriv.h"
